"""Create consulting_companies table and seed from hardcoded CONSULTING_COMPANIES list.
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("tenant_id", "name", name="uq_consulting_companies_tenant_name"),
    )
    op.create_index("ix_consulting_companies_tenant_id", "consulting_companies", ["tenant_id"])
    op.create_index("ix_consulting_companies_name", "consulting_companies", ["name"])
    op.create_index("ix_consulting_companies_active", "consulting_companies", ["active"])
...
def downgrade() -> None:
    op.drop_index("ix_consulting_companies_active", table_name="consulting_companies")
    op.drop_index("ix_consulting_companies_name", table_name="consulting_companies")
    op.drop_index("ix_consulting_companies_tenant_id", table_name="consulting_companies")
